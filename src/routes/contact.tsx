...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Trishul Visionary Studios" },
      { name: "description", content: "Let's build something visionary together. Reach the Trishul Visionary Studios team in Hyderabad." },
      { property: "og:title", content: "Contact — Trishul Visionary Studios" },
      { property: "og:description", content: "Let's build something visionary together." },
    ],
  }),
  component: Contact,
});
      ...
      <section className="mx-auto max-w-7xl px-6 pb-28 lg:px-10">
        <div className="grid gap-8 lg:grid-cols-[2fr_3fr]">
          ...
          <div className="space-y-4">
            {[
              { icon: MapPin, title: "Corporate Office", body: "Jubilee Hills / Kakatiya Hills\nHyderabad, Telangana, India" },
              { icon: Mail, title: "Email", body: "hello@trishulvisionary.com" },
              { icon: Phone, title: "Phone", body: "+91 (0) 40 0000 0000" },
            ].map((item) => (
